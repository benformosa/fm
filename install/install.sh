...
sudo wget -q https://raw.githubusercontent.com/benformosa/fml/master/install/fminstall.sh -O /srv/rails/fml/fminstall.sh
sudo chown fml:fml /srv/rails/fml/fminstall.sh
sudo chmod +x /srv/rails/fml/fminstall.sh

sudo /srv/rails/fml/fminstall.sh
